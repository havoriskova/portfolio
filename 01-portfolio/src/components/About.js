...
const About = () => {
    ...
    const techStackMore = <>
        ...
        <button className='button--show-more' onClick={() => setShowMoreStack(false)}>...show less</button>
        </>
    ...
    { showMoreStack ? (techStackMore) : (<button className='button--show-more' onClick={() => setShowMoreStack(true)}>...show more</button>
        )}
